...
Current test health is **91.5% passing** (940/1027). The 87 failing tests fall into 5 distinct categories, with **44 tests (50.6%) fixable within project scope** and **43 tests (49.4%) requiring deeper architectural changes**.
...
**Root cause**: SQLAlchemy models don't raise exceptions at instantiation time - they fail at commit time
...
**Root cause**: Tests expect `celery.current_task` to exist, but it's not available in test environment
