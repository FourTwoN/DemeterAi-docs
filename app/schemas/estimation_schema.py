...
class EstimationCreate(BaseModel):
    ...
    vegetation_polygon: dict = Field(..., description="Vegetation polygon coordinates")
    ...
    estimation_confidence: Decimal = Field(0.70, ge=0.0, le=1.0, description="ML confidence score")
