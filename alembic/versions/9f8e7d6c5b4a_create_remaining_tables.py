...
def upgrade() -> None:
    ...
    op.create_index('ix_packaging_materials_code', 'packaging_materials', ['code'])
    ...
    op.create_index('ix_packaging_colors_hex_code', 'packaging_colors', ['hex_code'])
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(['packaging_material_id'], ['packaging_materials.id'], ondelete='RESTRICT'),
        sa.ForeignKeyConstraint(['packaging_color_id'], ['packaging_colors.id'], ondelete='RESTRICT'),
        sa.PrimaryKeyConstraint('id'),
    ...
    op.create_index('ix_packaging_catalog_type', 'packaging_catalog', ['packaging_type_id'])
    ...
    op.create_table(
        ...
        sa.Column('wholesale_total_price_per_box', sa.Numeric(12, 2), nullable=True),
        sa.Column('observations', sa.Text(), nullable=True),
        sa.Column('availability', sa.String(50), nullable=True),
        sa.Column('discount_factor', sa.Numeric(5, 3), nullable=True),
        sa.Column('updated_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
        sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
        sa.ForeignKeyConstraint(['packaging_catalog_id'], ['packaging_catalog.id'], ondelete='CASCADE'),
        sa.ForeignKeyConstraint(['product_categories_id'], ['product_categories.id'], ondelete='CASCADE'),
        sa.PrimaryKeyConstraint('id'),
    ...
    op.create_table(
        ...
        sa.Column('has_packaging', sa.Boolean(), nullable=False, server_default='false'),
        ...
        sa.Column('quantity_empty_containers', sa.Integer(), nullable=False, server_default='0'),
        ...
        sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
        sa.Column('updated_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
        sa.CheckConstraint('quantity_initial >= 0', name='ck_stock_batch_qty_init'),
        sa.CheckConstraint('quantity_current >= 0', name='ck_stock_batch_qty_curr'),
        sa.CheckConstraint('quality_score >= 0 AND quality_score <= 5', name='ck_quality_score'),
        sa.ForeignKeyConstraint(['current_storage_bin_id'], ['storage_bins.bin_id'], ondelete='RESTRICT'),
        sa.ForeignKeyConstraint(['product_id'], ['products.id'], ondelete='RESTRICT'),
        sa.ForeignKeyConstraint(['product_state_id'], ['product_states.product_state_id'], ondelete='RESTRICT'),
        sa.ForeignKeyConstraint(['product_size_id'], ['product_sizes.product_size_id'], ondelete='SET NULL'),
    ...
    op.create_index('ix_stock_batches_batch_code', 'stock_batches', ['batch_code'])
    op.create_index('ix_stock_batches_product_id', 'stock_batches', ['product_id'])
    op.create_index('ix_stock_batches_bin_id', 'stock_batches', ['current_storage_bin_id'])
    ...
    op.create_table(
        ...
        sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
        sa.Column('session_id', sa.String(36), nullable=False, unique=True),  # UUID as string
        sa.Column('storage_location_id', sa.Integer(), nullable=True),
        sa.Column('original_image_id', postgresql.UUID(as_uuid=True), nullable=True),  # UUID reference
        sa.Column('processed_image_id', postgresql.UUID(as_uuid=True), nullable=True),  # UUID reference
        ...
        sa.Column('total_empty_containers', sa.Integer(), nullable=False, server_default='0'),
        sa.Column('avg_confidence', sa.Numeric(3, 2), nullable=True),
        sa.Column('category_counts', sa.JSON(), nullable=True),
        sa.Column('status', postgresql.ENUM('pending', 'processing', 'completed', 'failed', name='sessionstatusenum', create_type=False),
        ...
        sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
        sa.Column('updated_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
        sa.ForeignKeyConstraint(['storage_location_id'], ['storage_locations.location_id'], ondelete='SET NULL'),
        sa.ForeignKeyConstraint(['original_image_id'], ['s3_images.image_id'], ondelete='SET NULL'),
        sa.ForeignKeyConstraint(['processed_image_id'], ['s3_images.image_id'], ondelete='SET NULL'),
        sa.ForeignKeyConstraint(['validated_by_user_id'], ['users.id'], ondelete='SET NULL'),
        sa.PrimaryKeyConstraint('id'),
        comment='Photo processing sessions for ML pipeline'
    )
    op.create_index('ix_photo_sessions_session_id', 'photo_processing_sessions', ['session_id'])
    op.create_index('ix_photo_sessions_location_id', 'photo_processing_sessions', ['storage_location_id'])
    op.create_index('ix_photo_sessions_status', 'photo_processing_sessions', ['status'])
    ...
    op.create_table(
        ...
        sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
        sa.Column('product_id', sa.Integer(), nullable=False),
        sa.Column('image_id', postgresql.UUID(as_uuid=True), nullable=False),  # UUID reference to s3_images
        sa.Column('product_state_id', sa.Integer(), nullable=True),
        sa.Column('product_size_id', sa.Integer(), nullable=True),
        sa.Column('storage_location_id', sa.Integer(), nullable=True),
        sa.Column('sample_type', postgresql.ENUM('reference', 'growth_stage', 'quality_check', 'monthly_sample',
                                         name='sampletypeenum', create_type=False), nullable=False),
        ...
        sa.ForeignKeyConstraint(['image_id'], ['s3_images.image_id'], ondelete='CASCADE'),
        sa.ForeignKeyConstraint(['product_state_id'], ['product_states.product_state_id'], ondelete='SET NULL'),
        sa.ForeignKeyConstraint(['product_size_id'], ['product_sizes.product_size_id'], ondelete='SET NULL'),
        sa.ForeignKeyConstraint(['storage_location_id'], ['storage_locations.location_id'], ondelete='SET NULL'),
    ...
    op.create_index('ix_product_sample_images_product_id', 'product_sample_images', ['product_id'])
    ...
    op.create_table(
        'stock_movements',
        sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
        sa.Column('movement_id', sa.String(36), nullable=False, unique=True),  # UUID as string
        sa.Column('batch_id', sa.Integer(), nullable=False),
        sa.Column('movement_type', postgresql.ENUM('plantar', 'sembrar', 'transplante', 'muerte', 'ventas',
                                           'foto', 'ajuste', 'manual_init', name='movementtypeenum', create_type=False),
                  nullable=False),
        ...
        sa.Column('source_type', postgresql.ENUM('manual', 'ia', name='sourcetypeenum', create_type=False), nullable=False),
        ...
        sa.ForeignKeyConstraint(['source_bin_id'], ['storage_bins.bin_id'], ondelete='SET NULL'),
        sa.ForeignKeyConstraint(['destination_bin_id'], ['storage_bins.bin_id'], ondelete='SET NULL'),
        sa.ForeignKeyConstraint(['user_id'], ['users.id'], ondelete='RESTRICT'),
        sa.ForeignKeyConstraint(['processing_session_id'], ['photo_processing_sessions.id'], ondelete='SET NULL'),
        sa.PrimaryKeyConstraint('id'),
        comment='Stock movement history - tracks all quantity changes'
    )
    op.create_index('ix_stock_movements_movement_id', 'stock_movements', ['movement_id'])
    ...
    op.create_table(
        ...
        sa.Column('is_empty_container', sa.Boolean(), nullable=False, server_default='false'),
        sa.Column('is_alive', sa.Boolean(), nullable=False, server_default='true'),
        sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
        sa.ForeignKeyConstraint(['session_id'], ['photo_processing_sessions.id'], ondelete='CASCADE'),
    ...
    op.create_index('ix_detections_movement_id', 'detections', ['stock_movement_id'])
    ...
    op.create_table(
        ...
        sa.Column('calculation_method', postgresql.ENUM('band_estimation', 'density_estimation', 'grid_analysis',
                                                 name='calculationmethodenum', create_type=False), nullable=False),
        sa.Column('estimation_confidence', sa.Numeric(3, 2), nullable=False, server_default='0.70'),
        sa.Column('used_density_parameters', sa.Boolean(), nullable=False, server_default='false'),
        sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
        sa.ForeignKeyConstraint(['session_id'], ['photo_processing_sessions.id'], ondelete='CASCADE'),
        sa.ForeignKeyConstraint(['stock_movement_id'], ['stock_movements.id'], ondelete='SET NULL'),
        sa.ForeignKeyConstraint(['classification_id'], ['classifications.id'], ondelete='SET NULL'),
    ...
    op.create_index('ix_estimations_method', 'estimations', ['calculation_method'])
    ...
    op.create_table(
        ...
        sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
        sa.Column('updated_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
        sa.ForeignKeyConstraint(['storage_location_id'], ['storage_locations.location_id'], ondelete='CASCADE'),
        sa.ForeignKeyConstraint(['product_id'], ['products.id'], ondelete='RESTRICT'),
        sa.ForeignKeyConstraint(['packaging_catalog_id'], ['packaging_catalog.id'], ondelete='SET NULL'),
        sa.ForeignKeyConstraint(['expected_product_state_id'], ['product_states.product_state_id'], ondelete='RESTRICT'),
        sa.PrimaryKeyConstraint('id'),
        sa.UniqueConstraint('storage_location_id', 'product_id', 'packaging_catalog_id', name='uq_location_product_pkg'),
        comment='Configuration for what products/states are expected in each location'
    )
    op.create_index('ix_storage_location_config_location_id', 'storage_location_config', ['storage_location_id'])
    ...
    op.create_table(
        ...
        sa.Column('overlap_adjustment_factor', sa.Numeric(4, 2), nullable=False, server_default='0.85'),
        sa.Column('avg_diameter_cm', sa.Numeric(6, 2), nullable=True),
        sa.Column('notes', sa.Text(), nullable=True),
        sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
        sa.Column('updated_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
        sa.ForeignKeyConstraint(['storage_bin_type_id'], ['storage_bin_types.bin_type_id'], ondelete='CASCADE'),
        sa.ForeignKeyConstraint(['product_id'], ['products.id'], ondelete='CASCADE'),
        sa.ForeignKeyConstraint(['packaging_catalog_id'], ['packaging_catalog.id'], ondelete='CASCADE'),
        sa.PrimaryKeyConstraint('id'),
        sa.UniqueConstraint('storage_bin_type_id', 'product_id', 'packaging_catalog_id', name='uq_density_params'),
        comment='Density parameters for plant counting estimations'
    )
    op.create_index('ix_density_parameters_bin_type_id', 'density_parameters', ['storage_bin_type_id'])
    op.create_index('ix_density_parameters_product_id', 'density_parameters', ['product_id'])
