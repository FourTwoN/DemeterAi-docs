...
- **Dependencies**:
  - Blocks: [SCH001]
  - Blocked by: [SVC003-stock-movement-service, DB007-stock-movements-model, DB024-storage-location-config]
...
Create the **secondary stock initialization endpoint** for manual entry when photo-based counting is unavailable.
...
**Context**: This endpoint bypasses ML pipeline entirely. It's faster but requires careful validation to prevent data inconsistencies.
