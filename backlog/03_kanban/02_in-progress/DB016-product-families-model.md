...
- [X] All columns defined with correct types (family_id, category_id, name, scientific_name, description)
...
**File**: /home/lucasg/proyectos/DemeterDocs/backlog/03_kanban/02_in-progress/DB016-product-families-model.md
