...
**WIP (Work-In-Progress) Limits** constrain the number of cards allowed in each Kanban column simultaneously.
...
**Core Principle**: "Stop starting, start finishing" - Don't pull new work until current work is done.
