...
Comprehensive test suite for MLPipelineCoordinator - THE CRITICAL PATH orchestrator for DemeterAI v2.0 ML pipeline. This service coordinates all ML services (Segmentation, SAHI Detection, Band Estimation) into a production-ready pipeline.
